    ...
    >
      ...
      <div className="relative z-10 flex justify-center items-center h-full text-center text-white px-4 ">
        <div className="space-y-6 mt-40 mb-4">
          <h1 className="text-3xl sm:text-5xl md:text-5xl font-bold leading-tight">
            Revolutionizing Business and Government
          </h1>
          <h2 className="text-3xl sm:text-5xl md:text-5xl font-bold leading-tight">
            Operations with AI-Driven Solutions
          </h2>
          <p className="text-xl text-semibold w-full sm:w-[85%]  mx-auto">
          ...
          <div className="flex gap-6 flex-col justify-center sm:flex-row w-full sm:w-[80%] mx-auto ">
            <div className="bg-[#070708] border text-center shadow-lg transition-transform hover:scale-105 w-full md:w-[250px] p-5 rounded-xl space-y-3">
            ...
            <div className="bg-[#070708] border  shadow-lg transition-transform text-center hover:scale-105 w-full md:w-[250px] p-5 rounded-xl space-y-3">
              <button className="border-solid border rounded-lg p-3 border-[#FF00AD] text-center ">
                <Image
                  src={"/compliance.png"}
                  alt="const"
